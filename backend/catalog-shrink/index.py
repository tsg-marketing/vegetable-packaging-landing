"""
Business: Загружает YML-фид t-sib.ru, отдаёт товары термоусадочного оборудования, плёнки и сопутствующих товаров.
...
TARGET_CATEGORIES = {"340", "295", "345", "341", "342", "343", "344", "354", "357", "353", "355"}
