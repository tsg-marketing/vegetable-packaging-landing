"""
Business: Загружает YML-фид t-sib.ru, отдаёт товары картонажного оборудования — формирователи (559), заклейщики (558), картонажное (325).
