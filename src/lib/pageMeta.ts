...
export const PAGES_META: PageMeta[] = [
  ...
  {
    path: "/about_us",
    title: "О компании Техно-Сиб — оборудование для пищевых производств с 2001 года",
    description: "«Техно-Сиб» — более 25 лет оснащаем пищевые производства: мясо- и рыбопереработка, фасовка и упаковка, кондитерское оборудование, упаковочные материалы. Офисы и склады в Москве и Новосибирске.",
    image: "https://cdn.poehali.dev/projects/3f792b21-d338-4186-a2a6-6c21df1b4449/bucket/6987fa02-cd88-4e57-944b-bcaecae0723b.png",
  },
];
