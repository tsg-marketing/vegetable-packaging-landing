        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch py-8 lg:py-10">
          <div className="lg:col-span-6 pr-0 lg:pr-4 fade-up flex flex-col justify-center">
            ...
            <p className="text-[13px] text-[#777] leading-snug mt-4 max-w-xl">
              * Указанная цена действует только при самовывозе из склада в г. Челябинск или поставке плёнки
              по адресу на территории Уральского федерального округа, Республики Башкортостан или
              Оренбургской области. Цена не включает стоимость доставки. Для расчёта стоимости доставки
              и получения цены для других регионов обращайтесь по контактам на сайте.
            </p>
          ...
          <ShrinkCatalog
            ...
            tail={
              <div className="rounded-xl overflow-hidden flex flex-col text-white"
                style={{ background: "linear-gradient(160deg, #C24A00 0%, #E85D00 55%, #FF7A00 100%)" }}>
