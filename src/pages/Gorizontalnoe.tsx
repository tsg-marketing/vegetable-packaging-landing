...
const ADVANTAGES = [
  ...
  { img: "https://cdn.poehali.dev/projects/3f792b21-d338-4186-a2a6-6c21df1b4449/files/3b0e5ab2-df31-4fed-83ad-da34316b0784.jpg", title: "Быстрая переналадка — не нужен отдельный наладчик на смену", desc: "До 30 программ в памяти, переналадка за ~3 минуты, сенсорная панель" },
  ...
  { img: "https://cdn.poehali.dev/projects/3f792b21-d338-4186-a2a6-6c21df1b4449/files/b52328f5-da09-436c-afa9-ec8f19d2d4da.jpg", title: "Рама из углеродистой стали — минимум простоев на ремонте", desc: "Надёжные комплектующие и защитное покрытие рамы" },
];
...
const GUARANTEES = [
  { icon: "ShieldCheck", title: "Гарантия до 12 месяцев", desc: "На всё оборудование с бесплатной пусконаладкой" },
...
const FAQS = [
  ...
  { q: "Сколько стоит оборудование и что входит в цену?", a: "Стоимость горизонтальных упаковочных машин начинается от 440 000 ₽ и зависит от серии, ширины плёнки, производительности и набора опций. В цену входит само оборудование, комплект документов, пусконаладка и обучение операторов. Доступны лизинг и рассрочка — подберём удобную схему платежей. Стандартные модели есть на складах в Новосибирске и Москве: их можно отгрузить сразу после оплаты. Нестандартные конфигурации изготавливаются под заказ — ориентировочно 3–4 месяца с учётом доставки." },
...
export default function Gorizontalnoe() {
  ...
  useSeo(getPageMeta("/gorizontalnoe"));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center py-12 lg:py-0">
          <div className="lg:col-span-6 pr-0 lg:pr-4 fade-up">
            <h1 className="text-[clamp(26px,4vw,46px)] font-bold leading-[1.15] mb-5 text-[#1A1A1A]">
              Горизонтальные упаковочные машины <span style={{ color: "var(--orange)" }}>flow-pack</span> — 50+ моделей в наличии и под заказ
            </h1>

            <p className="text-[19px] sm:text-[21px] font-semibold text-[#1A1A1A] mb-8 max-w-xl leading-snug">
              До <span style={{ color: "var(--orange)" }}>330 упаковок</span> в минуту. Подберём модель под ваш продукт за 1 день — бесплатная консультация.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8 text-center">
            <button onClick={() => openFos()} className="btn-orange inline-flex items-center gap-2">
              ...
              Бесплатно: проведите тест-упаковку вашего продукта в нашем демозале
            </button>
          </div>
        </div>
      </section>
