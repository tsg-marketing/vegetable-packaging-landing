...
const sendLead = createLeadSender("Картонажное оборудование");
...
export default function Kartonajnoe() {
  ...
  useSeo(getPageMeta("/kartonajnoe"));
  ...
  const submitQuiz = useCallback(async (data: CartonQuizPayload): Promise<boolean> => {
    return sendLead({
      ...
      email: data.email,
      quiz: [
        { question: "Задача:", answer: data.task },
        { question: "Размер короба:", answer: data.size },
